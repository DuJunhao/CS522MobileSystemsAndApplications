...
public class ChatHelper {
    ...
    public void register (String chatName, ResultReceiver resultReceiver) {
        ...
        if (chatName != null && !chatName.isEmpty()) {
            // TODOsave the chat name and add a registration request to the request queue
    ...
    public void postMessage(String chatRoom, String text, ResultReceiver receiver) {
        if (text != null && !text.isEmpty()) {
            ...
            // TODOprovide a result receiver that will display a toast message upon completion
